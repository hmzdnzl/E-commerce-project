...
function OrderPage(props) {
  ...
  const [addressAndCartData, setAddressAndCartData] = useState(true);
...
/*     useEffect(() => {
  ...
  const onCardSubmit = async (data) => {
    try {
      ...
      const response = await axiosInstance.post("/user/card", payload);
  ...
  return (
    <section className="flex justify-center items-center flex-col md:flex md:flex-row px-4 w-full">
      <div className="flex flex-col w-full md:w-[70%]">
        <section id="addressCardButtons" className="flex justify-between">
          <a
        ...
        <div className=" flex justify-between">
          ...
          >
            ...
            <label htmlFor="">            
            <div className="border w-[25%] pl-2"> 
    ...
    <p>Adres bulunamadı.</p>
              ...
              >
                ...
                >
                  ...
                  <section className="flex flex-wrap justify-between w-full md:w-[75%]">
                    <div className="flex flex-col justify-between border w-[50%]">
      ...
      <div className=" font-montserrat mt-5 flex flex-col ">
