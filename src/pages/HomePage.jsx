      ...
      <header>
        ...
        >
          <div className="flex flex-col items-center justify-center w-[55%] z-10">
            ...
            <button onClick={() => window.location.href = '/shop'} className="text-[24px] bg-[#2DC071] w-[221px] h-[62px] text-white px-6 py-3 rounded-[5px]  font-bold z-10 hover:bg-[#1b82c9] transition mb-6">
              SHOP NOW
            </button>
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex justify-center items-center z-20">
              <div
                className={`bg-white w-[62px] h-[10px]  ${currentSlide === slides.herosecond.image ? "opacity-50" : ""}`}
              ></div>
              <div
                className={`bg-white w-[62px] h-[10px]  ${currentSlide === slides.herofirst.image ? "opacity-50" : ""}`}
              ></div>
            </div>
          </div>
