    ...
    <div className="w-full mx-auto font-montserrat md:w-[100%] ">
        ...
        <div className="md:flex md:justify-center md:gap-x-10">
          <div className="flex flex-col gap-y-8 ">
            <section className="w-[90%] flex flex-col mx-auto">
              <section
                className="md:w-[506px] md:h-[450px] w-full h-[277px] flex justify-between items-center bg-white relative overflow-hidden"
              >
                <button
                  onClick={handleSelectImage}
                  className="text-[70px] h-full text-[#FFFFFF] z-10"
                ...
                {selectedImage && (
                  <img
                    ...
                    className="max-h-full h-full w-auto object-contain mx-auto block"
          ...
          <section className="flex flex-col pl-5 mt-5 gap-y-9 mb-[100px]">
            <h1 className="text-[20px] text-[#252B42]">
              {productDetails.name}
            </h1>
            ...
            <nav className="flex gap-x-4">
              ...
              <button
                ...
                className="w-[40px] h-[40px] rounded-full bg-[#FFFFFF] border flex items-center justify-center text-[#000000] border-[#E8E8E8]"
              >
                <ShoppingCart />
              </button>
      ...
      <section className=" md:w-[53%] mx-auto flex flex-col gap-y-8">
        <nav className="flex gap justify-around md:flex md:justify-center mt-5 md:gap-x-10">
          <a
            className="text-[#737373] font-[600] underline text-[14px]"
            href=""
          >
            Description
          </a>
        ...
        <section className="md:flex ">
          <div className="w-[90%] md:w-[39%] md:flex mx-auto  md:mx-4 ">
            <img
              className="md:w-[316px] rounded-[6px] md:h-[372px] md:object-cover md:object-center md:object-no-repeat"
              src={
